...
const Sidebar: React.FC<SidebarProps> = ({ className }) => {
  return (
    <div className={cn("flex flex-col h-full w-64 bg-sidebar text-sidebar-foreground border-r border-sidebar-border", className)}>
      <div className="p-4 flex items-center space-x-3 border-b border-sidebar-border h-16 shrink-0">
